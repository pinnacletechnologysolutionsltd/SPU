...
The repository source is available under Apache-2.0; this paper is released
under CC BY 4.0.
\end{abstract}
...
kernels; general-purpose AI acceleration lies outside its scope. Repository
source is Apache-2.0, and this paper is CC BY 4.0.

\section*{Code and License}
Source and reproducible test commands are available at
\url{github.com/pinnacletechnologysolutionsltd/SPU} under Apache-2.0. This
paper is licensed under Creative Commons Attribution 4.0 International
(CC BY 4.0).
