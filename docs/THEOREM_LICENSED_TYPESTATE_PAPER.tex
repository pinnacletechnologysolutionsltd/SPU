...
R2 & ROTC angles 6–35 are RTL/trace-only here & RTL & \path{test_rotc_vm_rtl_trace.py} (72 angle x datapath checks over 36 angles; 288 lane comparisons) & §3.1 lines 118–121 \\
...
R4 & Tensegrity bounded state/fault/recovery model & RTL & \path{spu13_tensegrity_guard_tb.v} (5/5 cases); tensegrity regression (50 PASS) & §3.3 lines 141–144 \\
