# SPU Sovereign Southbridge Stack — Design Philosophy
...
## The Four-Layer Southbridge Stack
...
│  adapts the southbridge policy itself                       │
├─────────────────────────────────────────────────────────────┤
...
real-time southbridge with genuine decision-making capability — not just a timer.
