...
Exit: achieved in simulation/build on 2026-07-16: `TB_FILTER=som` has no
compile errors, exact ordering passes, seven-node latency is pinned at 434
clocks, and the Tang sidecar is packed/PnR-clean. Renewed board evidence remains
in Tranche 4 because the connected bench exposed no Tang FTDI loader.
...
## Tranche 3 — reproducible map and one-command demo
...
## Tranche 4 — silicon and cross-vendor closure
