...
module spu_fragment_pipe (
    ...
    wire [15:0] v0a0;
    assign v0a0 = v0_attr[63:48]; wire [15:0] v0a1 = v0_attr[47:32];
    wire [15:0] v0a2;
    assign v0a2 = v0_attr[31:16]; wire [15:0] v0a3 = v0_attr[15:0];
    wire [15:0] v1a0;
    assign v1a0 = v1_attr[63:48]; wire [15:0] v1a1 = v1_attr[47:32];
    wire [15:0] v1a2;
    assign v1a2 = v1_attr[31:16]; wire [15:0] v1a3 = v1_attr[15:0];
    wire [15:0] v2a0;
    assign v2a0 = v2_attr[63:48]; wire [15:0] v2a1 = v2_attr[47:32];
    wire [15:0] v2a2;
    assign v2a2 = v2_attr[31:16]; wire [15:0] v2a3 = v2_attr[15:0];

    // Combinational blend: Σ wi_n × vi_axis  (32-bit each, 16×16 products)
    wire [31:0] bnd_a0;
    assign bnd_a0 = w0_n*v0a0 + w1_n*v1a0 + w2_n*v2a0;
    wire [31:0] bnd_a1;
    assign bnd_a1 = w0_n*v0a1 + w1_n*v1a1 + w2_n*v2a1;
    wire [31:0] bnd_a2;
    assign bnd_a2 = w0_n*v0a2 + w1_n*v1a2 + w2_n*v2a2;
    wire [31:0] bnd_a3;
    assign bnd_a3 = w0_n*v0a3 + w1_n*v1a3 + w2_n*v2a3;
    wire [15:0] w_total;
    assign w_total = w0_n + w1_n + w2_n;
