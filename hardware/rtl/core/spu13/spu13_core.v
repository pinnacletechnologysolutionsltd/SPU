...
module spu13_core #(
    ...
    // Instantiate davis_to_rplu to compute RPLU values & comparator
    wire rplu_dissoc;
    wire rplu_done;
    ...
    wire axis_stable;
    assign axis_stable = (quadrance_err <= 32'h0000_1000) && !rplu_dissoc;
    ...
    always @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            audio_mode <= 2'b00; // Default: Silent (Serious mode)
            torus_idx <= 10'd0;
        end else begin
