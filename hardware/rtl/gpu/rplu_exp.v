...
module rplu_exp #(
    ...
    initial begin
        ...
        $readmemh("hardware/rtl/arch/pade_num_4_4_q32.mem", pade_num_q32);
        $readmemh("hardware/rtl/arch/pade_den_4_4_q32.mem", pade_den_q32);
        // also read Q16 for tools that expect them
        $readmemh("hardware/rtl/arch/pade_num_4_4.mem", pade_num_q16);
        $readmemh("hardware/rtl/arch/pade_den_4_4.mem", pade_den_q16);
    end
