...
module rplu_poly_step(
    ...
    // Arithmetic shift right by 32 to align Q32 multiply result (preserve full width)
    wire signed [191:0] shifted = prod >>> 32;
    // Sign-extend coef (64 -> 192) to match shifted width for correct addition
    wire signed [191:0] coef_ext = {{128{coef_q32[63]}}, coef_q32};
    wire signed [191:0] sum192 = shifted + coef_ext;

    // Truncate/pack to 128-bit accumulator width (matches existing acc width in RPLU)
    assign acc_out = sum192[127:0];
