// spu13_tang25k_som_bmu_probe.v -- Tang 25K SOM/BMU silicon probe.
//
// Self-checking board proof for the seven-node rational SOM fixture. The probe
// instantiates spu_som_bmu and spu_cluster_reduce, checks two oracle scenarios,
// then emits a compact UART status line.
//
// UART at 115200 baud:
//   SOM:P T:2 B:6 E:00  PASS
//   SOM:F T:<n> B:<b> E:<code>  FAIL

module spu13_tang25k_som_bmu_probe (
    input  wire       sys_clk,
    output wire [2:0] led,
    output wire       uart_tx
);
