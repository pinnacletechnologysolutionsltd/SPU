// Tang Primer 25K B2/J3 pin-14 hold-low probe.
//
// Drives the 40-pin SDRAM/DVP header B2 line low continuously and reports the
// sampled pad level over UART. A healthy, unforced pin should report low.

module spu_tang25k_b2_hold_probe (
    input  wire sys_clk,
    output wire [2:0] led,
    output wire uart_tx,
    ...
    wire [31:0] report_word = {28'hB200000, 3'b000, b2_latch};
