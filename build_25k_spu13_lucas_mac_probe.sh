...
python3 tools/collect_fpga_metrics.py \
    ...
    --note "FAST_ONLY=1; covers PSCALE/PCHIRAL and PSCALE zero-drift, not PHSLK/PMUL/PINV silicon."
...
echo "  LUCAS:P  ← PASS (PSCALE/PCHIRAL fast paths + 100-period zero-drift)"
echo "  LUCAS:F  ← FAIL"
