#!/usr/bin/env python3
"""Generate Padé [2/2] coefficients in Q32 and improved Q16 rounding.
Outputs:
 - hardware/common/rtl/gpu/pade_num_2_2_q32.mem (64-bit hex per line)
 - hardware/common/rtl/gpu/pade_den_2_2_q32.mem (64-bit hex per line)
 - hardware/common/rtl/gpu/pade_num_2_2.mem (Q16.16)
 - hardware/common/rtl/gpu/pade_den_2_2.mem (Q16.16)
"""
from math import factorial
from fractions import Fraction

# Maclaurin coefficients for exp(-x): a_k = (-1)^k / k!
a = [Fraction(( -1)**k, factorial(k)) for k in range(6)]  # 0..5
n = 2
m = 2
# Build system for denominator b1..bm
...
with open('hardware/common/rtl/gpu/pade_num_2_2_q32.mem','w') as f:
    for v in num_q32:
        f.write('{:016x}\n'.format(v & 0xffffffffffffffff))
with open('hardware/common/rtl/gpu/pade_den_2_2_q32.mem','w') as f:
    for v in den_q32:
        f.write('{:016x}\n'.format(v & 0xffffffffffffffff))
with open('hardware/common/rtl/gpu/pade_num_2_2.mem','w') as f:
    for v in num_q16:
        f.write('{:08x}\n'.format(v & 0xffffffff))
with open('hardware/common/rtl/gpu/pade_den_2_2.mem','w') as f:
    for v in den_q16:
        f.write('{:08x}\n'.format(v & 0xffffffff))

print('Wrote Q32 and Q16 Padé [2/2] mem files')
